...
export default function Section7() {
    return (
         <section className='container mx-auto mt-32 mb-44 max-md:text-center'>
            <h1 className='font-semibold text-[40px] mt-32 mb-4' >Our <span className='text-green+'>Achievement</span></h1>
            <p className='font-normal text-xl text-[#6d737a] mb-101 '>we achieved remarkable results through various domains</p>
            <div className='flex items-center gap-32 my-16 '>
                <div className='flex items-center justify-between flex-1'>
                    <div className="flex flex-col">
                      <div className=' flex max-md:flex-col items-center gap-1 justify-between mb-8'>
                      ...
                      <div className='flex items-center  gap-2 mt-8 max-md:flex-col'>
                    ...
                    <div className='flex flex-col'>
                          <div className='flex items-center gap-2 max-md:flex-col mb-8'>
                        ...
                        <div className='flex items-center gap-2 max-md:flex-col mt-8'>
