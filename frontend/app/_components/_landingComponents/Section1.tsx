  ...
  return (
    <header className='container mx-auto mt-20 mb-20 flex max-md:flex-col justify-between'>
        <section className='flex flex-col w-[49%]  max-md:w-[100%] mx-auto mt-8 '>
            ...
            <button className='flex flex-row justify-center my-4 items-center mx-1 max-md:hidden px-4 py-2 w-[40%] max-sm:w-16 max-sm:h-8 max-sm:text-sm h-11 bg-neworg border-2 border-neworg rounded-lg order-5 self-stretch flex-grow-0 text-white text-base'>Learn more <PlayArrowIcon /> </button>
