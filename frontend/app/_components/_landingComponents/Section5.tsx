...
export default function Section5() {
    return (
        <section className='bg-[#f4fbf9] h-[560px]  '>
            <div className="container  mx-auto flex  gap-12 max-md:flex-col max-md:text-center py-16  mt-30">
                <div className='flex-1  '>
                    <h1 className='font-semibold text-[50px] mb-5'>We provide <span className='text-green+'>two types</span> of courses</h1>
                    <p className='font-medium text-base text-[#6D737A] mr-10'>Saas become a common delivery model for many business application, including office software,messaging software,payroll processing software,DBMS software, management software</p>
                </div>
