  ...
  return (
    <div className=" justify-around sticky  flex flex-col items-center px-4 py-8  w-1/4 h-[100vh] top-0 left-0 bg-white shadow-md rounded-l-[20px]">
      <div className="flex justify-between flex-col h-[45%] w-full">
        <div className="w-28 h-28 max-md:w-20 max-md:h-20   mx-auto mb-4">
          <img
            src={user?.pfp.url}
            className=" w-20 h-20 max-md:w-15 max-md:h-15  rounded-full  object-cover object-center overflow-hidden  "
            alt=""
          />
        ...
        <div className="mx-auto">
          ...
          <ul className="text-base font-medium mt-8">
            {user?.roles &&
            Object.values(user?.roles as number[])[0] === ROLES.Admin ? (
              <ul className="flex flex-col">
                ...
                <Link
                  ...
                  className={`px-4 py-2 ${
                    pathname === "/profile/admin/students"
                      ? " text-green+"
                      : "text-black"
                  } `}
                >
                  {" "}
                  <span className=" max-md:hidden">students</span>
                </Link>
                <Link
                  href={"/profile/admin/teachers"}
                  className={`px-4 py-2 ${
                    pathname === "/profile/admin/teachers"
                      ? " text-green+"
                      : "text-black"
                  } `}
                >
                  {" "}
                  <span className=" max-md:hidden">teachers</span>
                </Link>
                <Link
                  href={"/profile/admin/courses"}
                  className={`px-4 py-2 ${
                    pathname === "/profile/admin/courses"
                      ? " text-green+"
                      : "text-black"
                  } `}
                >
              ...
              <ul className="flex flex-col">
                <Link
                  href={"/profile"}
                  className={`px-4 py-2 ${
                    pathname === "/profile" ? " text-green+" : "text-black"
                  } `}
                >
                  {" "}
                  <Person2OutlinedIcon />{" "}
                ...
                <Link
                  href={"/profile/addCourse"}
                  className={`px-4 py-2 ${
                    pathname === "/profile/addCourse"
                      ? " text-green+"
                      : "text-black"
                  } `}
                >
                ...
                <Link
                  href={"/profile/publishedCourses"}
                  className={`px-4 py-2 ${
                    pathname === "/profile/publishedCourses"
                      ? " text-green+"
                      : "text-black"
                  } `}
                >
                  {" "}
                  <FolderIcon />{" "}
                  <span className=" max-md:hidden">published courses</span>
                </Link>
                <Link
                  href={"/profile/settings"}
                  className={`px-4 py-2 ${
              ...
              user?.roles &&
              Object.values(user?.roles as number[])[0] === ROLES.User && (
                <ul className="flex flex-col">
                  <Link
                    href={"/profile/settings"}
                    className={`px-4 py-2 ${
                  ...
                  >
                    {" "}
                    <MailIcon /> <span className=" max-md:hidden">inbox</span>
                  </Link>
                  <Link
      ...
      <button
        onClick={signout}
        className="font-medium text-base text-[#ff0000]"
      >
        <LogoutIcon />
