...
const WelcomHeader = (props: Props) => {
    ...
    return (
        <div>
        <div className='flex flex-row justify-between my-2 content-center items-center max-md:flex-col max-sm:content-start max-sm:items-start gap-3'>
                            <div className='w-[75%] bg-[#00977D] flex flex-row gap-6 rounded-[20px] justify-between max-sm:w-[50%]'>
